...
correctMap = {result.split(": ")[0]: int(result.split(": ")[1])
              for result in correctFile.readlines()}
incorrectMap = {result.split(": ")[0]: int(result.split(
    ": ")[1]) for result in incorrectFile.readlines()}
